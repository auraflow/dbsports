...
SECRET_KEY = 'django-insecure-z&6y*=03w%pia*tr##xvbt(ojznz8ucmy+^fcaksh-gvj%+0m-'
...
# Настройки пользовательской авторизации
LOGIN_URL = 'login'              # Куда отправлять неавторизованных (название маршрута)
LOGIN_REDIRECT_URL = 'dashboard' # Куда отправлять после успешного входа
